...
class HomeActivityReportExampleScreen extends ConsumerStatefulWidget {
  const HomeActivityReportExampleScreen({super.key});

  @override
  ConsumerState<HomeActivityReportExampleScreen> createState() => HomeActivityReportExampleScreenState();
}

class HomeActivityReportExampleScreenState extends ConsumerState<HomeActivityReportExampleScreen> with HomeController, MyController {
