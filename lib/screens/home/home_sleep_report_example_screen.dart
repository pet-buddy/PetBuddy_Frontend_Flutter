...
class HomeSleepReportExampleScreen extends ConsumerStatefulWidget {
  const HomeSleepReportExampleScreen({super.key});

  @override
  ConsumerState<HomeSleepReportExampleScreen> createState() => HomeSleepReportExampleScreenState();
}

class HomeSleepReportExampleScreenState extends ConsumerState<HomeSleepReportExampleScreen> with HomeController, MyController {
